...
if (stockCount <= 1) {
  console.log (`I'm going to eat some ${food}!`)  
    ...
    console.log(`We need to go get some more ${food}!`)
}
//prints we need to go get some more Pickles!//
...
if (isFavorite === true) {
  ...
  //prints My favorite food is Pickles! // 
...
var vegtables = ['carrots', 'peas', 'bellPeppers', 'spinach', 'eggplant'];


// Write the code to access the 3rd element of the Array, using bracket
// notation.

//console.log(vegtables[3]);//
//prints spinach//

// Create a new variable "fruits" and assign it to an Array of 7
// different fruits.

var fruits = ['pineapple', 'grapes', 'kiwi', 'apple', 'grapefruit', 'blueberries', 'nana'];
